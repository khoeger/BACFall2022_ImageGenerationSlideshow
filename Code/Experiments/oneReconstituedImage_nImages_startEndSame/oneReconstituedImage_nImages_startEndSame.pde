...
String imageCollection = "OssiningTallFall2022";
...
void setup() {
  ...
  startMin = String.valueOf( minute() );
  startTime = startYear + startMonth + startDay + "_" +startHour + startMin;
  println( startTime );
  ...
  // record start shape and brush type
  recordStartShapeImage ();
